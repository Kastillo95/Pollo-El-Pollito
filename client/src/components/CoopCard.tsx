...
export default function CoopCard({ coop, onEdit }: CoopCardProps) {
  ...
  // Different stock photos for variety
  const imageUrls = [
    "https://images.unsplash.com/photo-1548550023-2bdb3c5beed7?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&h=200",
    "https://images.unsplash.com/photo-1516467508483-a7212febe31a?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&h=200",
    "https://images.unsplash.com/photo-1560732488-6b0df240254a?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&h=200"
  ];
